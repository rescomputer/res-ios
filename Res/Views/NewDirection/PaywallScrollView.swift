...
private var titleAndDescriptionView: some View {
         VStack(alignment: .leading, spacing: 10) {
            VStack(alignment: .leading, spacing: 5) {
                ...
                //     .foregroundColor(.white)
                //     .padding(.top, 30)
                Text("Upgrade to RES Pro to enjoy unlimited calls with your contacts. Discover endless possibilities with diverse personalities, voices, and more.")
                    .font(.system(size: 16))
                ...
                Text("Payment is charged to the iTunes account associated with your device at confirmation of purchase. Subscription automatically renews unless auto-renew is turned off at least 24 hours before the end of the current period unless auto-renew is tuned off.")
                    .font(.system(size: 9, weight: .regular))
                    .foregroundColor(.white.opacity(0.7))
                    .padding(.bottom, 5)

                Text("You can manage your subscription on your membership page or in your Account settings.")
                    .font(.system(size: 9, weight: .regular))
                    .foregroundColor(.white.opacity(0.7))
                }
        }
